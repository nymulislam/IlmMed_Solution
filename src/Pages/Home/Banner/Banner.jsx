          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-xl">
              ...
              <div className="grid gap-4">
                ...
                <button
                  onClick={() => handleCopy(banner.coupon, banner.couponRate)}
                  data-tooltip-id="coupon-tooltip"
                  data-tooltip-content="Click to Copy Coupon Code"
                  data-tooltip-place="bottom"
                  className=" px-6 text-lg max-w-md mx-auto btn btn-secondary text-white hover:border-[#3398db] bg-gradient-to-r from-[#ff7675] to-[#d63031]"
                >
                  Apply Coupon:{" "}

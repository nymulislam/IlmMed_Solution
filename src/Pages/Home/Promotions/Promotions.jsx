    ...
    <div className="shadow-lg">
      ...
      <div>
        <Swiper
          ...
          className="mySwiper h-60 bg-[#354a5f]"
        >
           {
            promotions.map((promotion) => (
                <SwiperSlide key={promotion?._id}>
                    <div className="text-center py-12">
                    <h1 className="text-2xl md:text-4xl text-[#d6f5e3] font-semibold">{promotion?.title}</h1>
                    <p className="md:text-xl px-6 md:px-28 py-2 md:py-5 text-[#d6f5e3] font-medium md:font-semibold">{promotion?.description}</p>
